...
function Footer() {
  return (
    <div className="container mx-auto p-4 bg-[#FFDEDE]">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <ul className="space-y-2">
                ...
                <li>
                  <NavLink to="/gallery" className={"hover:text-[#EC1D1E] hover:underline"}>
                    Gallery
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/contact" className={"hover:text-[#EC1D1E] hover:underline"}>
                    Contact
                  </NavLink>
                </li>
              </ul>
        ...
        <div className="p-10">
          ...
          <div className="relative flex">
            <button
              className="absolute right-1 text-center align-middle text-normal font-semibold text-white bg-[#EC1D1E] w-[95px] 
              rounded-md top-2"
              type="button"
            >
              Subscribe
          ...
          <h2 className="text-xl font-normal mb-4 text-[#EC1D1E]">Follow on</h2>
            <NavLink>
              <svg
