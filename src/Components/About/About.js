...
const About = () => {
  return (<div>
    ...
    <div dir="ltr" className=" max-[912px]:hidden  flex ps-[5.5%]  h-dvh bg-cover bg-center w-full overflow-hidden"
      style={{ backgroundImage: `url('/images/Group42.jpg')` }}
    >
      <div className=' md:w-[380px] lg:w-[480px]  xl:w-[600px]' >
    ...
    <div className=' min-[913px]:hidden
      ...
      <div className=' h-screen w-full flex flex-col items-center space-y-[35px] max-[540px]:space-y-[30px] ' >
        ...
        <p className='  px-[7.5%]  text-[20px] text-start ' >
    ...
    <div dir="rtl" className=" max-[912px]:hidden   w-full ps-[5.5%] h-dvh bg-cover bg-center overflow-hidden"
      style={{ backgroundImage: `url('/images/page2.jpg')` }}
    >
      <div dir="ltr" className='h-auto lg:w-[660px] xl:w-[840px] mt-3' >
        ...
        <p className=' lg:text-[15px] xl:text-[21px] mt-8 text-start ' >The
        ...
        <p className=' lg:text-[15px] xl:text-[21px]  mt-8 text-start ' >Richa's vision for the MAA Foundation is not just about providing immediate help. It's about equipping individuals with the skills and knowledge they need to improve their own lives and contribute positively to society. Her work with the foundation reflects her belief in the power of education and the importance of providing equal opportunities for everyone.
        </p>
