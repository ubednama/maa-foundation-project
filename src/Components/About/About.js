...
const About = () => {
  return (
    <>
      ...
      >
        <div className='relative p-10 md:p-16 lg:w-[480px] xl:w-[800px] bg-opacity-70'>
          <h1 className="lg:text-4xl xl:text-5xl text-primary-base font-semibold">Maa Foundation</h1>

          <p className='xl:text-2xl mt-8 text-start !leading-10'>
      ...
      >
        <div dir="ltr" className='relative p-10 lg:w-[660px] xl:w-[840px] bg-white bg-opacity-70'>
